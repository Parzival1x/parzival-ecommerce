...
<footer>
        <div class="footer-content">
            ...
            <div class="footer-ul-container">
                <ul class="category">
                    <li class="category-title">Royal Furnitures</li>
                    <li><a href="#" class="footer-link">Bedrooms</a></li>
                    <li><a href="#" class="footer-link">Couch Furnitures</a></li>
                    <li><a href="#" class="footer-link">Tables</a></li>
                    <li><a href="#" class="footer-link">TV Units</a></li>
